...
import { Wrap, WrapItem, Button, useInterval } from '@chakra-ui/react'
...
import { increment, decrement, incrementInterval, setFlashCardState, setDefaultFlashCard } from '../../features/runFlashCard'
	...
	return (
		<>
			...
			<Wrap justifyContent={"center"} justify='center' mt={5}>
				...
				<WrapItem onClick={() => {triggerPlaying(isPlaying)}} >
					<StartStopButton/>
				</WrapItem>
				<WrapItem>
					<LButton rightIcon={<BiArrowBack style={{ transform: 'rotate(180deg)' }} size={30} onClick={() => {forward()}} />}>
					</LButton>
				</WrapItem>
			</Wrap>
		</>
